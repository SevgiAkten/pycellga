...
Note:The problem is to evolve a solution the vector of x consisting in 6 real parameters (the vector of x =< a1, w1, a2, w2, a3, w3 >) each one encoded with 8 bits in the range [-6.4, 6.35]. References 1. and 2.
Of course it could encoded with 32 bits, then the length of chromosomes is equal to 192. References 3. and 4.
"""

# Length of chromosomes = 64
# Maximum Fitness Value = 0
# The treshold is assumed 0.0001
...
class Fms(AbstractProblem):
    def f(self, x: list) -> float:
        ...
        a1 = -6.4+(12.75*(a1_int/255.0))
        w1 = -6.4+(12.75*(w1_int/255.0))
        a2 = -6.4+(12.75*(a2_int/255.0))
        w2 = -6.4+(12.75*(w2_int/255.0))
        a3 = -6.4+(12.75*(a3_int/255.0))
        w3 = -6.4+(12.75*(w3_int/255.0))
